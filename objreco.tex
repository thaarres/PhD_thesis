...
When a hadron decays, it hadronises and produces a shower of particles originating from roughly the same vertex. These decay products mainly consist of charged and neutral pions, neutrons or kaons.  With PF objects like charged hadrons, neutral hadrons and photons defined, an attempt to associate these particles to one common origin, a mother particle, is performed. This is done through the clustering of PF objects associated to the same HCAL cluster, one containing several particles in close vicinity of one another.

\subsection{Jet clustering}

The default jet clustering algorithm in CMS, is the anti-\kt algorithm~\cite{Cacciari:2008gp}. The anti-\kt algorithm,
