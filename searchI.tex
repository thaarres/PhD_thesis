...
The decay products of a hadronically decaying boosted vector boson, will therefore not appear as back-to-back in the lab frame but rather be very collimated. The distance between the two quarks depends on the mass of the vector boson and its \PT and goes as
\begin{equation*}  
\Delta R = \frac{2 M_{V}}{p_{T,V}}.  
\end{equation*}
Above a W \PT of 200 GeV, the two quarks are merged into a single large cone jet of size R = 0.8. A sketch of  
\begin{figure}[ht] 
    \centering
    \includegraphics[width=0.90\textwidth]{figures/analysis/search1/misc/WWqqqq_unmerged_small.pdf}\\
    ...
    \label{fig:searchI:unmerged}
\end{figure}

\begin{figure}[ht] 
    \centering
    \includegraphics[width=0.90\textwidth]{figures/analysis/search1/misc/WWqqqq_merged_small.pdf}
