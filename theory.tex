...
The group $SU(3)_C$ represents the strong force and the corresponding gluon field tensor $G_{\mu\nu}^a$. $a$ runs over the eight generators of the group, which correspond to eight massless spin-1 gluons. As this is a non-Abelian group (where a group operation on two group elements depend on the order they are written), the gluons are charged with a \emph{color} charge, $C$, and display self-interactions. Quarks, the only fundamental particles interacting with the strong force, are the simplest representation of $SU(3)$. Interactions via the strong force are described by the quantum gauge theory Quantum Chromodynamics (QCD). 
\subsection{The electroweak sector}
The electromagnetic and weak interactions arise from the breaking of $SU (2)_L \otimes U(1)_Y$ symmetry. The gauge field tensor of $SU (2)_L$,the group of weak left-handed isospin, is $W_{\mu\nu}^a$ where $a$ runs over the 3 generators of the group. All the fermions listed above have a \emph{chirality}, defined as the projection of the particles spin along its direction of motion. The fermions with a left-handed chirality are in the doublet representation of $SU(2)$ and the fermions of right-handed chirality are in the singlet representation, meaning they do not interact with the gauge bosons of $W_{\mu\nu}^a$ (hence the name weak left-handed isospin). The final group, $U(1)_Y$ of weak hypercharge, is abelian and hence has no self-interaction. The interactions are mediated by a neutral particle with the gauge field tensor $B_{\mu\nu}^a$.
